...
class NewsInfoTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        imageViewLike.tintColor = UIColor.brandGrey
        imageViewShare.tintColor = UIColor.brandGrey
        imageViewComment.tintColor = UIColor.brandGrey
        imageViewViews.tintColor = UIColor.brandGrey
    }
