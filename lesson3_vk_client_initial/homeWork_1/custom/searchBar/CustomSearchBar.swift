...
class CustomSearchBar: UIView {
    ...
    func setSubViews(width: CGFloat) {
        ...
        buttonCancel.setTitleColor(UIColor.brandWhite, for: .normal)
//        buttonCancel.titleLabel?.font = UIFont.boldSystemFont(ofSize: 16)
        buttonCancel.backgroundColor = UIColor.brandGreyRed
        buttonCancel.cornerRadius = 5
        
        imageView.image = UIImage(named: "search")
        imageView.contentMode = .scaleAspectFit
        imageView.tintColor = UIColor.brandWhite
        
        textField.textColor = UIColor.brandWhite
